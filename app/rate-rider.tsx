...
import { RiderRatingService } from '@/lib/rider-rating-service';
...
export default function RateRiderScreen() {
  const { rideId, riderId, riderName } = useLocalSearchParams<{ rideId: string; riderId: string; riderName: string }>();
  ...
  const handleSubmit = async () => {
    ...
    try {
      await RiderRatingService.submitRating({
        rideId,
        userId: riderId,
        rating,
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            How was your experience with {riderName || 'this rider'}?
          </Text>
        </View>
